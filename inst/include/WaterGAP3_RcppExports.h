...
namespace WaterGAP3 {
    ...
    inline NumericVector confluen_WaterGAP3(NumericVector confluen_cellInflow_m3, NumericVector& river_water_m3, NumericVector river_length_km, NumericVector river_velocity_km, IntegerVector riverlake_cellNumber_int, NumericVector& riverlake_water_m3, NumericVector riverlake_capacity_m3, IntegerVector reservoir_cellNumber_int, NumericVector& reservoir_water_m3, NumericVector reservoir_capacity_m3, NumericVector reservoir_demand_m3, NumericVector reservoir_yearInflow_m3, NumericVector reservoir_yearDemand_m3, NumericVector& reservoir_yearRelase_m3, LogicalVector reservoir_isOperateStart_01, LogicalVector reservoir_isIrrigate_01, List basin_cellNumberStep_int, List basin_inflowCellNumberStep_int, NumericVector param_lake_acp_storeFactor, NumericVector param_lake_acp_gamma, NumericVector param_riverlake_lin_storeFactor, NumericVector param_reservoir_han_alpha, NumericVector param_reservoir_han_kDemand) {
        typedef SEXP(*Ptr_confluen_WaterGAP3)(SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP,SEXP);
        static Ptr_confluen_WaterGAP3 p_confluen_WaterGAP3 = NULL;
        if (p_confluen_WaterGAP3 == NULL) {
            validateSignature("NumericVector(*confluen_WaterGAP3)(NumericVector,NumericVector&,NumericVector,NumericVector,IntegerVector,NumericVector&,NumericVector,IntegerVector,NumericVector&,NumericVector,NumericVector,NumericVector,NumericVector,NumericVector&,LogicalVector,LogicalVector,List,List,NumericVector,NumericVector,NumericVector,NumericVector,NumericVector)");
            p_confluen_WaterGAP3 = (Ptr_confluen_WaterGAP3)R_GetCCallable("WaterGAP3", "_WaterGAP3_confluen_WaterGAP3");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_confluen_WaterGAP3(Shield<SEXP>(Rcpp::wrap(confluen_cellInflow_m3)), Shield<SEXP>(Rcpp::wrap(river_water_m3)), Shield<SEXP>(Rcpp::wrap(river_length_km)), Shield<SEXP>(Rcpp::wrap(river_velocity_km)), Shield<SEXP>(Rcpp::wrap(riverlake_cellNumber_int)), Shield<SEXP>(Rcpp::wrap(riverlake_water_m3)), Shield<SEXP>(Rcpp::wrap(riverlake_capacity_m3)), Shield<SEXP>(Rcpp::wrap(reservoir_cellNumber_int)), Shield<SEXP>(Rcpp::wrap(reservoir_water_m3)), Shield<SEXP>(Rcpp::wrap(reservoir_capacity_m3)), Shield<SEXP>(Rcpp::wrap(reservoir_demand_m3)), Shield<SEXP>(Rcpp::wrap(reservoir_yearInflow_m3)), Shield<SEXP>(Rcpp::wrap(reservoir_yearDemand_m3)), Shield<SEXP>(Rcpp::wrap(reservoir_yearRelase_m3)), Shield<SEXP>(Rcpp::wrap(reservoir_isOperateStart_01)), Shield<SEXP>(Rcpp::wrap(reservoir_isIrrigate_01)), Shield<SEXP>(Rcpp::wrap(basin_cellNumberStep_int)), Shield<SEXP>(Rcpp::wrap(basin_inflowCellNumberStep_int)), Shield<SEXP>(Rcpp::wrap(param_lake_acp_storeFactor)), Shield<SEXP>(Rcpp::wrap(param_lake_acp_gamma)), Shield<SEXP>(Rcpp::wrap(param_riverlake_lin_storeFactor)), Shield<SEXP>(Rcpp::wrap(param_reservoir_han_alpha)), Shield<SEXP>(Rcpp::wrap(param_reservoir_han_kDemand)));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (Rcpp::internal::isLongjumpSentinel(rcpp_result_gen))
