...
// run_WaterGAP3_N
NumericMatrix run_WaterGAP3_N(int n_Time, int n_Spat, std::string name_Region, std::string index_Time, std::string path_MeteoInput, std::string path_HydroParam, std::string path_InitialState, std::string path_Boundary, std::string path_VariExport, std::string path_FinalState);
static SEXP _WaterGAP3_run_WaterGAP3_N_try(SEXP n_TimeSEXP, SEXP n_SpatSEXP, SEXP name_RegionSEXP, SEXP index_TimeSEXP, SEXP path_MeteoInputSEXP, SEXP path_HydroParamSEXP, SEXP path_InitialStateSEXP, SEXP path_BoundarySEXP, SEXP path_VariExportSEXP, SEXP path_FinalStateSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< int >::type n_Time(n_TimeSEXP);
    Rcpp::traits::input_parameter< int >::type n_Spat(n_SpatSEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type path_VariExport(path_VariExportSEXP);
    Rcpp::traits::input_parameter< std::string >::type path_FinalState(path_FinalStateSEXP);
    rcpp_result_gen = Rcpp::wrap(run_WaterGAP3_N(n_Time, n_Spat, name_Region, index_Time, path_MeteoInput, path_HydroParam, path_InitialState, path_Boundary, path_VariExport, path_FinalState));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _WaterGAP3_run_WaterGAP3_N(SEXP n_TimeSEXP, SEXP n_SpatSEXP, SEXP name_RegionSEXP, SEXP index_TimeSEXP, SEXP path_MeteoInputSEXP, SEXP path_HydroParamSEXP, SEXP path_InitialStateSEXP, SEXP path_BoundarySEXP, SEXP path_VariExportSEXP, SEXP path_FinalStateSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_WaterGAP3_run_WaterGAP3_N_try(n_TimeSEXP, n_SpatSEXP, name_RegionSEXP, index_TimeSEXP, path_MeteoInputSEXP, path_HydroParamSEXP, path_InitialStateSEXP, path_BoundarySEXP, path_VariExportSEXP, path_FinalStateSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _WaterGAP3_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("NumericMatrix(*run_WaterGAP3_N)(int,int,std::string,std::string,std::string,std::string,std::string,std::string,std::string,std::string)");
