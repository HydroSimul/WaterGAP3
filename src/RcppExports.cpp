...
// evatransActual_WaterGAP
NumericVector evatransActual_WaterGAP(NumericVector ATMOS_potentialEvatrans_mm, NumericVector water_mm, NumericVector capacity_mm, NumericVector param_EVATRANS_wat_petmax);
static SEXP _WaterGAP3_evatransActual_WaterGAP_try(SEXP ATMOS_potentialEvatrans_mmSEXP, SEXP water_mmSEXP, SEXP capacity_mmSEXP, SEXP param_EVATRANS_wat_petmaxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< NumericVector >::type ATMOS_potentialEvatrans_mm(ATMOS_potentialEvatrans_mmSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type water_mm(water_mmSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type capacity_mm(capacity_mmSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type param_EVATRANS_wat_petmax(param_EVATRANS_wat_petmaxSEXP);
    rcpp_result_gen = Rcpp::wrap(evatransActual_WaterGAP(ATMOS_potentialEvatrans_mm, water_mm, capacity_mm, param_EVATRANS_wat_petmax));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _WaterGAP3_evatransActual_WaterGAP(SEXP ATMOS_potentialEvatrans_mmSEXP, SEXP water_mmSEXP, SEXP capacity_mmSEXP, SEXP param_EVATRANS_wat_petmaxSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_WaterGAP3_evatransActual_WaterGAP_try(ATMOS_potentialEvatrans_mmSEXP, water_mmSEXP, capacity_mmSEXP, param_EVATRANS_wat_petmaxSEXP));
    }
    Rboolean rcpp_isInterrupt_gen = Rf_inherits(rcpp_result_gen, "interrupted-error");
    if (rcpp_isInterrupt_gen) {
        UNPROTECT(1);
...
static int _WaterGAP3_RcppExport_validate(const char* sig) { 
    ...
    if (signatures.empty()) {
        ...
        signatures.insert("NumericVector(*evatransActual_WaterGAP)(NumericVector,NumericVector,NumericVector,NumericVector)");
...
RcppExport SEXP _WaterGAP3_RcppExport_registerCCallable() { 
    ...
    R_RegisterCCallable("WaterGAP3", "_WaterGAP3_evatransActual_WaterGAP", (DL_FUNC)_WaterGAP3_evatransActual_WaterGAP_try);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_WaterGAP3_evatransActual_WaterGAP", (DL_FUNC) &_WaterGAP3_evatransActual_WaterGAP, 4},
