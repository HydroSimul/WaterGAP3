...
#' @export
run_WaterGAP3_N <- function(n_Time, n_Spat, name_Region, index_Time, path_MeteoInput, path_HydroParam, path_InitialState = "UNKNOW", path_Boundary = "UNKNOW", path_VariExport = "NonExport", path_FinalState = "NonExport") {
    .Call(`_WaterGAP3_run_WaterGAP3_N`, n_Time, n_Spat, name_Region, index_Time, path_MeteoInput, path_HydroParam, path_InitialState, path_Boundary, path_VariExport, path_FinalState)
}
